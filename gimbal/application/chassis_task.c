...
void chassis_task(void const *pvParameters)
{
    ...
    while (1)
    {
        ...
        {
            //发送控制数据
            CAN_cmd_chassis(chassis_move.chassis_yaw_motor->gimbal_motor_measure->ecd - chassis_move.chassis_yaw_motor->frist_ecd, chassis_move.vx_set, chassis_move.vy_set, chassis_move.chassis_behaviour);
        }
