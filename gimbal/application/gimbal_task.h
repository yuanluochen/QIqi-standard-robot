...
//云台pitch轴最大值相对角度
#define GIMBAL_PITCH_MAX_ENCODE 0X1D14
//云台pitch轴最小相对角
#define GIMBAL_PITCH_MIN_ENCODE 0X1301
//云台pitch轴中值
#define GIMBAL_PITCH_OFFSET_ENCODE 0x17F9
//云台yaw轴中值
#define GIMBAL_YAW_OFFSET_ENCODE 0x1FF4
//yaw轴后侧中值
